      ...
      {activeItem && (
        <>
          ...
          {/* <div
            ...
            className={`absolute left-1/2 z-10 grid place-items-center border-[2px] border-white rounded-full cursor-pointer transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)] ${
              isMoving
                ? "bottom-[-80px] opacity-0 pointer-events-none duration-100 scale-0 -translate-x-1/2"
                : "bottom-[18vh] md:bottom-[2em] opacity-100 pointer-events-auto duration-500 scale-100 -translate-x-1/2"
            }`}
          >
            <p
          ...
          <div className="absolute left-1/2 bottom-[18vh] md:bottom-[2em] z-10 flex md:gap-10 gap-8 -translate-x-1/2">
            {/* Forward Button */}
            <div
              onClick={handleButtonClick}
              style={{
